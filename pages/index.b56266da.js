...
*****/ (function() {
    $.fn.extend({
        textEffectLoop: function(options) {
            ...
            return this.each(function() {
                ...
                return parent.children().off("texteffectend").on("texteffectend", function() {
                    ...
                    isForward = !isForward;
                    self = $(this);
                    if (isForward === true) return setTimeout(function() {
                        ...
                        if (self.next().length) return self.next().textEffect(settings);
                        else {
                            ticker++;
                            if (settings.loop === "infinite" || ticker < settings.loop) // console.log("infinite");
                            return parent.children().first().textEffect(settings);
                            else // console.log("texteffectloopend");
        ...
        textEffect: function(options) {
            ...
            log = function(msg) {
                if (settings.debug) return typeof console !== "undefined" && console !== null ? console.log(msg) : void 0;
            };
            ...
            return this.each(function() {
                ...
                render = function(output) {
                    ...
                    if (++currentFrameNum === totalFrameNum) {
                        if (settings.reverse) // console.log(currentFrameNum);
                        $(self).html(text).hide();
                ...
                for(indexer = _i = 1, _ref = text.length; 1 <= _ref ? _i <= _ref : _i >= _ref; indexer = 1 <= _ref ? ++_i : --_i){
                    if (ticker > text.length) break;
                    for(x = _j = 1, _ref1 = settings.repeat; 1 <= _ref1 ? _j <= _ref1 : _j >= _ref1; x = 1 <= _ref1 ? ++_j : --_j){
                        output = "";
                        for(y = _k = 0, _ref2 = ticker - 1; 0 <= _ref2 ? _k <= _ref2 : _k >= _ref2; y = 0 <= _ref2 ? ++_k : --_k)if (y < (ticker - 1) / 2) output += text[y];
                        else output += getRandomChar();
                        outputs.push(output);
                    }
                    if (ticker === text.length) break;
                    ticker *= 2;
                    if (ticker > text.length) ticker = text.length;
                }
                for(indexer = _l = _ref3 = parseInt(text.length / 2, 10), _ref4 = text.length - 1; _ref3 <= _ref4 ? _l <= _ref4 : _l >= _ref4; indexer = _ref3 <= _ref4 ? ++_l : --_l){
                    ...
                    for(x = _m = _ref5 = parseInt(text.length / 2 + 1, 10), _ref6 = text.length - 1; _ref5 <= _ref6 ? _m <= _ref6 : _m >= _ref6; x = _ref5 <= _ref6 ? ++_m : --_m)if (x < tickerFromMiddle) output += text[x];
                    else output += getRandomChar();
                    tickerFromMiddle++;
                    outputs.push(output);
                }
                if (settings.reverse) outputs.reverse();
                _results = [];
...
//# sourceMappingURL=index.b56266da.js.map
